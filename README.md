...
```
I need you to clone this Git repo (https://github.com/belangerc1/Appcues-Mobile-Demo-App.git)
and place it in my Documents, in a new folder titled appcues-mobile-app-demo
```
